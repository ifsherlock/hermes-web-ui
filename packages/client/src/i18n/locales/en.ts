export default {
  ...
  models: {
    ...
    fetchModelsMissingBaseUrl: 'Provider Base URL is missing',
    fallbackTitle: 'Fallback Strategy',
    fallbackSubtitle: 'When the model actually used by the current session fails or returns no output, retry through the fallback chain.',
    fallbackAddRule: 'Add rule',
    fallbackSearchPlaceholder: 'Search profile, provider, or model',
    fallbackWarningCount: '{count} fallback item(s) need attention.',
    fallbackEmpty: 'No fallback rules yet',
    fallbackPrimaryModel: 'Primary / trigger model',
    fallbackDefaultChain: 'Default fallback chain',
    fallbackDefaultChainHint: 'Used for any failed session model unless a more specific rule matches.',
    fallbackDefaultEmpty: 'No default fallback models yet',
    fallbackAdvancedRules: 'Advanced overrides',
    fallbackAdvancedHint: 'Override the default chain by profile, provider, or specific model.',
    fallbackOverrideRule: 'Override scope',
    fallbackScopeModel: 'Specific model',
    fallbackScopeProvider: 'Provider',
    fallbackScopeProfile: 'Profile',
    fallbackChain: 'Fallback chain',
    fallbackAddTarget: 'Add fallback model',
    fallbackMoveUp: 'Move up',
    fallbackMoveDown: 'Move down',
    fallbackRemoveTarget: 'Remove',
    fallbackRetryRunFailed: 'Run failed',
    fallbackRetryEmptyOutput: 'Completed with no output',
    fallbackAllProfiles: 'All profiles',
    fallbackSaved: 'Fallback strategy saved',
    fallbackSaveFailed: 'Failed to save fallback strategy',
