export default {
  ...
  models: {
    ...
    fetchModelsMissingBaseUrl: '缺少 Provider Base URL',
    fallbackTitle: 'Fallback 策略',
    fallbackSubtitle: '当前会话实际使用的模型失败或无输出时，按备用模型链自动重试。',
    fallbackAddRule: '新增规则',
    fallbackSearchPlaceholder: '搜索 profile、provider 或模型',
    fallbackWarningCount: '有 {count} 个 fallback 配置项需要检查。',
    fallbackEmpty: '暂无 fallback 规则',
    fallbackPrimaryModel: '主模型 / 触发模型',
    fallbackDefaultChain: '默认备用链',
    fallbackDefaultChainHint: '任何会话模型失败且没有命中高级规则时，按这里的顺序重试。',
    fallbackDefaultEmpty: '暂无默认备用模型',
    fallbackAdvancedRules: '高级覆盖规则',
    fallbackAdvancedHint: '按 profile、provider 或具体模型覆盖默认备用链。',
    fallbackOverrideRule: '覆盖范围',
    fallbackScopeModel: '具体模型',
    fallbackScopeProvider: 'Provider',
    fallbackScopeProfile: 'Profile',
    fallbackChain: '备用模型链',
    fallbackAddTarget: '添加备用模型',
    fallbackMoveUp: '上移',
    fallbackMoveDown: '下移',
    fallbackRemoveTarget: '移除',
    fallbackRetryRunFailed: '运行失败',
    fallbackRetryEmptyOutput: '无输出完成',
    fallbackAllProfiles: '全部 profile',
    fallbackSaved: 'Fallback 策略已保存',
    fallbackSaveFailed: 'Fallback 策略保存失败',
    auxiliaryTitle: '辅助模型',
